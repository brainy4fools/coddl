...
<div class="pmf-container">
    ...
    <input name="Enable_Notifications" type="text" class="form-control f" placeholder="Type here" data-toggle="tooltip" data-placement="top" value="<?php echo set_value('Enable_Notifications',$key->Enable_Notifications); ?>">
    <div class='errors'>
...
<div class="form-group">
    ...
    <label>Send_by</label>  
    <div class="igs-small"></div>
    <input name="Send_by" type="text" class="form-control f" placeholder="Type here" data-toggle="tooltip" data-placement="top" value="<?php echo set_value('Send_by',$key->Send_by); ?>">
    <div class='errors'>
...
<div class="form-group">
    ...
    <div class="igs-small"></div>
    <input name="Reminder_advance_notice" type="text" class="form-control f" placeholder="Type here" data-toggle="tooltip" data-placement="top" value="<?php echo set_value('Reminder_advance_notice',$key->Reminder_advance_notice); ?>">
    <div class='errors'>
