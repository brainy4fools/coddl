...
<div class="pmf-container">
    ...
    <?php $this->load->view('admin/staff/breadcrumb-edit'); ?>
    <div class="row" style="margin-left:30px; margin-right:30px;">
        <div class="col-sm-12">
            <header class="panel-heading font-bold shade-t">Edit staff
                <div class="pull-right btn btn-sm  btn-info btn-rounded" data-toggle="popover" data-html="true" data-placement="top" data-content="Edit staff" title="" data-original-title="<button type=&quot;button&quot; class=&quot;close pull-right&quot; data-dismiss=&quot;popover&quot;>×</button>Info"> <i class="fa fa-question"></i> <strong></strong> </div>
            </header>
            <section class="panel">
                <div class="panel-body shade-b">
                    <form action="<?php echo site_url("admin/staff/edit_staff/$id"); ?>" method="post" enctype="multipart/form-data">
                        <?php foreach ($query->result() as $key): ?>
                        <div class="form-group">
    <!-- <div class="errors pull-left">*</div> -->
    <label>First Name</label> <div class='errors inline'>*</div> 
...
<div class="form-group">
    <!-- <div class="errors pull-left">*</div> -->
    <label>Last Name</label> <div class='errors inline'>*</div> 
    <div class="igs-small"></div>
...
<div class="form-group">
    <label>Notes</label> 
    <div class="igs-small"></div>
    <textarea name="Notes"  id="inp-box" class="form-control f" rows="5"  placeholder="Type here" data-toggle="tooltip" data-placement="top"><?php echo set_value('Notes',$key->Notes); ?></textarea>
    <div class='errors'>
...
<div class="form-group">
    ...
    <div class="igs-small"></div>
    <input name="Appointment_Colour" type="text" class="form-control f" placeholder="Type here" data-toggle="tooltip" data-placement="top" value="<?php echo set_value('Appointment_Colour',$key->Appointment_Colour); ?>">
    <div class='errors'>
