...
<div class="form-group">
    ...
    <textarea name="SMS_Template"  id="inp-box" class="form-control f" rows="5"  placeholder="Type here" data-toggle="tooltip" data-placement="top" readonly><?php echo set_value('SMS_Template',$key->SMS_Template); ?></textarea>
    <div class='errors'>
...
<div class="form-group">
    ...
    <textarea name="Reschedule_Template"  id="inp-box" class="form-control f" rows="5"  placeholder="Type here" data-toggle="tooltip" data-placement="top" readonly><?php echo set_value('Reschedule_Template',$key->Reschedule_Template); ?></textarea>
    <div class='errors'>
...
<div class="form-group">
    ...
    <textarea name="Confirm_Template"  id="inp-box" class="form-control f" rows="5"  placeholder="Type here" data-toggle="tooltip" data-placement="top" readonly><?php echo set_value('Confirm_Template',$key->Confirm_Template); ?></textarea>
    <div class='errors'>
...
<div class="form-group">
    ...
    <textarea name="Cancelled_Template"  id="inp-box" class="form-control f" rows="5"  placeholder="Type here" data-toggle="tooltip" data-placement="top" readonly><?php echo set_value('Cancelled_Template',$key->Cancelled_Template); ?></textarea>
    <div class='errors'>
